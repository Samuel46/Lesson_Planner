...
import { Home, LogIn, Smile } from "react-feather";
import { loginSchool } from "../../actions/auth/authSchool";
...
function Login({ isAuthenticated, loginSchool }) {
...
Login.propTypes = {
  loginSchool: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { loginSchool })(Login);
